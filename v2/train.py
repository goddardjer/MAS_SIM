...
def train(
    ...
    #             # Pass aggregated features to critic
    #             centralized_value = critic_model(aggregated_features).squeeze(-1)  # Shape: [num_envs]

    #         # Sample actions and compute log probabilities
    #         actions_sample = dist.rsample()
    #         action_log_prob = dist.log_prob(actions_sample).sum(-1)

    #         # Clip actions and store data
    ...
    #         # If agents are ordered per environment, you can reshape
    ...
    #         # Process observations, rewards, and dones as before
